...
public partial class Reports_Quarter : System.Web.UI.Page
{
    ...
    protected void btnGenerateReport_click(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter adp = new SqlDataAdapter("select * from tblquarters where isnull(Status,0)=" + drpQuarterStatus.SelectedValue, con);
        try
        {
