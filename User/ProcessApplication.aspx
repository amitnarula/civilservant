    ...
    <div class="contentContainer" style="width: 100%">
        ...
        <table border="0" cellpadding="0" cellspacing="5" class="table" width="100%">
            <tr>
                ...
                <th align="left">Allotted Quarter
                </th>
            </tr>
            <tr>
                <td>
        ...
        <asp:Panel runat="server" ID="pnlChangeRequestInformation" Visible="false">
            <table border="0" cellpadding="0" cellspacing="0" class="table">
                <tr>
                    <th align="left">Change Request
                </th>
                    <th align="left">Quarter Category
                </th>
                    <th align="left">First Preference
                </th>
                    <th align="left">Second Preference
                </th>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label Text="N/A" runat="server" ID="lblQuarterCategory" />
                    </td>
                    <td>
        ...
        <asp:Panel ID="pnlApplyForChangeRequestSpecialCaseOfGradeDowngrade" CssClass="left"  runat="server" Visible="false">
            <br />
            <asp:Button Text="Apply for change request in your previous category" CssClass="btn btn-success" OnClick="btnChangeRequest_Click" ID="btnChangeRequestSpecialCase" runat="server" />
        </asp:Panel>
        <br />
        <asp:Panel runat="server" ID="pnlChangeRequest" CssClass="table-responsive" Visible="false" Width="100%">
            ...
            <div class="alert alert-info">
                <div>Please Note:</div>
                <div>
                    1. Quarters marked in Green colour are Vacant as of
            now.
                </div>
                <div>
                    2. Allotment for Change option is based on the criteria of “First
